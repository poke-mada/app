        ...
        <div class="row h-25" v-if="team === 'you'">
          <div class="col-8">
            <div class="row" v-if="this.selectedPokemon">
              <MovementCard class="col-6" :movement="this.selectedPokemon.move1"/>
              <MovementCard class="col-6" :movement="this.selectedPokemon.move2"/>
              <MovementCard class="col-6" :movement="this.selectedPokemon.move3"/>
              <MovementCard class="col-6" :movement="this.selectedPokemon.move4"/>
            </div>
          </div>
          <div class="col-4"></div>
        </div>
