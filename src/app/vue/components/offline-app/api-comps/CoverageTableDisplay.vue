    ...
    <v-col md="4">
      <v-card height="75vh">
        <PokemonTeamList team="you"
                         ...
                         :data="this.combat_data.your_trainer.current_team"
                         :trainer_name="this.combat_data.your_trainer.name"/>
        <PokemonTeamList team="enemy"
                         @pokemon_selected="select_enemy_pokemon"
                         :force_plain="this.selected_slot_from === 'you'"
                         :data="this.combat_data.enemy_trainer.current_team"
...
<script>
import {POKEMON_TYPES} from "@/data/type_data.js";
import PokemonTeamList from '@/app/vue/components/offline-app/api-comps/PokemonTeamList.vue';
